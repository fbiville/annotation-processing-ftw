package fr.devoxx.niveau3.exo1.etape3;
...
public class Etape3Test {
  @Test(enabled = false)
  public void compilation_should_fail_when_a_property_is_annotated_with_Inject_and_indicate_annotation_line_and_file() throws Exception {
